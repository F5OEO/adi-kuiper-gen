...
export CONFIG_MOSQUITTO=${CONFIG_MOSQUITTO:-n}
export CONFIG_READDSB=${CONFIG_READDSB:-n}
export CONFIG_RTL433=${CONFIG_RTL433:-n}
export CONFIG_TEZUKA_TOOLS=${CONFIG_TEZUKA_TOOLS:-n}
export CONFIG_OPENWEBRX=${CONFIG_OPENWEBRX:-n}
export CONFIG_ACARSVDL=${CONFIG_ACARSVDL:-n}
export CONFIG_REMOTESDR=${CONFIG_REMOTESDR:-n}
export CONFIG_CLEAN_ROOTFS=${CONFIG_CLEAN_ROOTFS:-n}
export CONFIG_NETPLAN=${CONFIG_NETPLAN:-n}
export CONFIG_DAB=${CONFIG_DAB:-n}

#tezuka boot
export CONFIG_TEZUKA_BOOT_FILES=${CONFIG_TEZUKA_BOOT_FILES:-n}
